...
export default function ThemeToggle() {
  ...
  return (
    <Switch
      ...
      className="group relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-surface-raised transition-colors duration-200 ease-in-out focus:outline-none focus:ring-1 focus:ring-accent focus:ring-offset-2 data-[checked]:bg-surface-raised"
    >
      ...
      <span className="pointer-events-none relative inline-block h-5 w-5 transform rounded-full bg-white dark:bg-emerald-600 shadow ring-0 transition duration-200 ease-in-out group-data-[checked]:translate-x-5">
        ...
        >
          {/* Off Toggle */}
          <SunIcon className="text-accent-text"/>
        </span>
        <span
          aria-hidden="true"
